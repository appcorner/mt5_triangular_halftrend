...
symbol = get_str('setting', 'symbol', 'USDJPY')
buy_symbol = get_str('setting', 'buy_symbol', 'EURUSD')
arb_symbol = get_str('setting', 'arb_symbol', 'EURJPY')
triangle_symbols = get_list('setting', 'triangle_symbols', ['EURUSD', 'EURJPY'])
symbols = [symbol] + triangle_symbols
...
is_triangular_signal = get_str('setting', 'triangular_signal', 'off') == 'on'
...
tp_amount = get_float('setting', 'tp_amount', 100.0)
